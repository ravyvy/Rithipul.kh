...
function renderHome(home) {
      ...
      card = `
        <div class="col-lg-4">
          <div class="feature-card">
            ...
            <div class="feature-content title-font">
              <h3 data-en="${item.category_en}" data-kh="${item.category_kh}">
                ${title}
              </h3>
  ...
  <div class="event-item">
    ...
    /* ================= VISSION ================= */
    if (item.type === "vission" && vissionList) {
      card = `
        <div class="col-md-6">
          <img src="${item.img}" class="img-fluid w-100 h-100" style="object-fit: cover;">
        </div>
        <div class="col-md-6">
          <div class="card-body p-4 p-lg-5">
            <h4 class="fw-bold" style="color: rgb(19, 73, 138);"
            ...
            <a href="about.html" class="btn btn-primary btn-sm">See more!</a>
          </div>
        </div>
      `;
      ...
      card = `
        <div class="col-lg-6">
          <div class="value-card" style="background-color: rgba(183,145,68,1);">
            ...
            <div style="text-align: justify; width: 400px; margin: auto;">
